...
const mock = {
  ...
  feature2:
    'Optional integration of bulb / LED headlamp driving',
  feature3:
    'Separate capacitor support for EFI loads',
  feature4:
    'Cycle-by-cycle regulation control',
  title:
    'Voltage Regulators',
...
const ProductLine2 = () => {
  ...
  const gaEventTracker = useAnalyticsEventTracker('Click-VRR');
  return (
    <Box>
      <Box
        component={'a'}
          ...
          >
            <Box>
              ...
              <Typography variant={'subtitle1'} gutterBottom sx={{fontWeight: 700}}>
                <Link href='/products/small-engines' color="inherit">for ICE Powered Motorcycles/Scooters</Link>
              </Typography>
