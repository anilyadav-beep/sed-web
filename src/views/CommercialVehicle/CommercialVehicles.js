...
import ACE from '../../assets/applications/ACENEW.png';
      ...
      >
        <Container>
          <Box display={'flex'} flexDirection={'column'} alignItems={'center'}>
            <Welcome typed="vehicles" evapplication={ACE} headerText1='Engine and Aftertreatment control solutions for Diesel / Gas Powered '/>
            <Box marginTop={ 15}>
              <NoSsr>
                <Box
                  component={'svg'}
