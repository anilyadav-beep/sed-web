...
import TermsAndConditionsOfAppointmentOfIndependentDirector from '../../../assets/brochures/TermsAndConditionsOfAppointmentOfIndependentDirector.pdf';
...
const disclosureData = [
  {
    ...
    fileUrl: MemorandumOfAssociation,
  },
  {
    title: 'Articles Of Association',
    fileUrl: ArticlesOfAssociation,
  },
  {
    title: 'Terms And Conditions Of Appointment Of Independent Directors',
    fileUrl: TermsAndConditionsOfAppointmentOfIndependentDirector,
  },
];
...
const Disclosures = () => {
  return (
    <Main>
      <Container>
        <Box sx={{ p: 0, mt: 0 }} minHeight="60vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center">
          <Typography
            color="#A03811"
            variant="h3"
            textAlign="center"
